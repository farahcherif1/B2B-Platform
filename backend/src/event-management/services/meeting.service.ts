...
export class MeetingService {
  ...
  async create(createMeetingDto: CreateMeetingDto) {
    ...
    const hostId = String(createMeetingDto.hostId);
    const guestId = String(createMeetingDto.guestId);
    const sessionId = String(createMeetingDto.sessionId);
    const intervalId = String(createMeetingDto.intervalId);
    const locationId = String(createMeetingDto.locationId);
    const eventId = String(createMeetingDto.eventId);
