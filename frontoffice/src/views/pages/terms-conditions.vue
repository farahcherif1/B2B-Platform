...
<template>
  <BCol col lg="10" class="w-100">
    <BCard no-body>
      <div class="bg-warning-subtle position-relative">
        <BCardBody class="p-5 bg-primary">
          <div class="text-center">
            <h3 class="text-white">Term & Conditions</h3>
          </div>
        </BCardBody>
        <div class="shape">
          <svg
      ...
      <BCardBody class="p-4">
        ...
        <div
          class="text-end hstack gap-2 justify-content-end"
          style="margin-top: 5rem"
        >
          <BButton pill variant="outline-primary" class="w-25" @click="goBack">
            Retourner
          </BButton>
        </div>
      </BCardBody>
