...
<template>
  <div id="layout-wrapper">
    <NavBar />
    <div>
      <div class="app-menu navbar-menu bg-secondary border-secondary">
        <!-- LOGO -->
        <div class="navbar-brand-box bg-secondary">
          <router-link to="/" class="logo logo-light">
            <span class="logo-lg">
              <img
                src="@/assets/images/cepex-logo.svg"
                class="mt-4 p-4"
                style="background-color: #bcc6cf; border-radius: 28px"
              />
            </span>
          </router-link>
          <BButton
        ...
        <simplebar id="scrollbar" class="h-100 bg-secondary" ref="scrollbar">
          <Menu></Menu>
        </simplebar>
